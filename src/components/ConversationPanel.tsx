    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-ink">AI 问答</span>
        </div>
        {onNewChat && (
          <button
            onClick={onNewChat}
            className="flex items-center gap-1 text-[10px] text-link hover:text-link/80 hover:bg-cream px-2 py-1 rounded-md border border-transparent hover:border-brand/20 transition-all"
            title="新对话"
          >
