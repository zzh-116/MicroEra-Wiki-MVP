  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-50 p-3 rounded-lg text-left text-[11px] text-gray-500 w-full border border-gray-150 space-y-1">
        <div className="font-bold text-ink mb-1">🔐 访问规则说明：</div>
      ...
      <button
        ...
        className="w-full py-2 bg-ink hover:bg-ink/95 text-white font-bold rounded-lg text-xs transition-all flex items-center justify-center space-x-1.5"
      >
        <span>前往企业登录控制台</span>
